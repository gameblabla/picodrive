...
const struct in_default_bind in_sdl_defbinds[] = {
	...
	#if defined(__RG99__)
	{ SDLK_LCTRL,	IN_BINDTYPE_PLAYER12, GBTN_A },
	{ SDLK_LALT,	IN_BINDTYPE_PLAYER12, GBTN_B },
	{ SDLK_LSHIFT,	IN_BINDTYPE_PLAYER12, GBTN_C },
	{ SDLK_SPACE,	IN_BINDTYPE_PLAYER12, GBTN_X },
	{ SDLK_TAB,	IN_BINDTYPE_PLAYER12, GBTN_Y },
	{ SDLK_BACKSPACE,	IN_BINDTYPE_PLAYER12, GBTN_Z },
	#else
	...
	#if defined(__RG99__)
	{ SDLK_PAGEUP, IN_BINDTYPE_EMU, PEVB_MENU },
	#elif defined(__RG350__)
